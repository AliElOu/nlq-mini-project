        ...
        with self.get_connection() as conn:
            ...
            conn.execute("""
                CREATE TABLE IF NOT EXISTS products (
                    ...
                    gender VARCHAR(20) DEFAULT 'unisexe' CHECK (gender IN ('homme', 'femme', 'enfant', 'unisexe')),
                    season VARCHAR(20) DEFAULT 'toute_saison' CHECK (season IN ('printemps', 'été', 'automne', 'hiver', 'toute_saison')),
            ...
            conn.execute("""
                CREATE TABLE IF NOT EXISTS orders (
                    ...
                    status VARCHAR(20) DEFAULT 'en_attente' CHECK (status IN ('en_attente', 'confirmé', 'expédié', 'livré', 'annulé')),
